  ...
  return (
    <>
      <a
        ...
        ref={targetCategories}
        onClick={handleOpen}
      >
        <Image className="flex-shrink-0" width={16} height={16} src={menu} />
      </a>
      <Overlay
        rootClose
        onHide={handleClose}
              ...
              <div className="row g-0">
                <div className="col-4 caca border-3">
                  <div className="item_categories">
                    <img
                      className="svg_categories mx-3"
                      src="/img/categories/suitecase.svg"
                    />
                  ...
                  <div className="item_categories">
                    ...
                    <svg className="svg_categories mx-3" viewBox="0 0 20 20">
                      ...
                      <image
                        ...
                        width="20"
                        height="20"
                        href="/img/categories/soleil.svg"
                      />
                    </svg>
                    <span>Vacances</span>
                  </div>
                  ...
                  <div className="item_categories">
                    <img
                      className="svg_categories mx-3"
                      src="/img/categories/armchair.svg"
                    />
                    Maison
                  </div>
                  <div className="item_categories">
                    <img
                      className="svg_categories mx-3"
                      src="/img/categories/multimedia.svg"
                    />
                    Multimédia
                  </div>
                  <div className="item_categories">
                    <img
                      className="svg_categories mx-3"
                      src="/img/categories/loisirs.svg"
                    />
                    Loisirs
                  </div>
                  <div className="item_categories">
                    <img
                      className="svg_categories mx-3"
                      src="/img/categories/animaux.svg"
                    />
                    Animaux
                  </div>
                  <div className="item_categories">
                  ...
                  <div className="item_categories">
                    <img
                      className="svg_categories mx-3"
                      src="/img/categories/services.svg"
                    />
                    Service
                  </div>
                  <div className="item_categories">
