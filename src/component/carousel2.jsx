      ...
      >
        <div className="">
          <div className="display-relative carousel_img_container rounded mx-2 px-1 bg-white">
            ...
            <h5 className="display-absolute fixed-bottom text-white text-center">
              Vêtements
            </h5>
          </div>
        </div>
        <div>
          <div className="carousel_img_container rounded mx-2 px-1 bg-white">
            <img
              ...
              src="/img/carousel/offres_emploi.avif"
            />
            <h5 className="display-absolute fixed-bottom text-white text-center">
              Offre d'emploi
            </h5>
        ...
        <div>
          <div className="carousel_img_container rounded mx-2 px-1 bg-white">
            <img
              className="img_carousel"
              src="/img/carousel/ventes_immo.avif"
            />
            <h5 className="display-absolute fixed-bottom text-white text-center">
              Vente immo
            </h5>
        ...
        <div>
          <div className="carousel_img_container rounded mx-2 px-1 bg-white">
            ...
            <h5 className="display-absolute fixed-bottom text-center text-white">
              Voitures
            </h5>
          </div>
        </div>
