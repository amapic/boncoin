      ...
      >
        ...
        >
          <div
            style={{ width: "170px" }}
            id="logo"
            className="hidden-xl d-flex flex-column justify-content-center align-items-left"
          >
            <Image width={140} height={24} src={bon_coin} />
          </div>
          <div>
            <div
              style={{ height: "40px" }}
              className="p-2 orange justify-content-center align-items-center border rounded d-flex flex-row"
            >
              {/* <div className=""> */}
              <Image width={24} height={24} src={plus} />
              {/* </div> */}
        ...
        >
          ...
          >
            <div className="img_navbar">
              <Image width={24} height={24} src={cloche} />
            </div>
          ...
          <div className="px-10 nav-item d-flex flex-column justify-content-center align-items-center">
            <div className="img_navbar">
              <Image width={24} height={24} src={coeur} />
            </div>
            <div style={{ fontSize: "12px" }} className="txt_sous_img_navbar">
              Favoris
            </div>
          ...
          >
            <div className="img_navbar">
              <Image width={24} height={24} src={msg} />
            </div>
            <div style={{ fontSize: "12px" }} className="txt_sous_img_navbar">
              Messages
            </div>
          ...
          >
            <div className="img_navbar">
              <Image width={24} height={24} src={perso} />
            </div>
            <div style={{ fontSize: "12px" }} className="txt_sous_img_navbar">
              Se connecter
            </div>
